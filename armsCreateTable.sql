...
CREATE TABLE `deployments` (
	  ...
	  `actualDeploymentDate` varchar(100),
	  `actualDeploymentTimeOfDay` varchar(100) DEFAULT NULL,
	  `actualRecoveryDate` varchar(100),
	  `actualRecoveryTimeOfDay` varchar(100) DEFAULT NULL,
